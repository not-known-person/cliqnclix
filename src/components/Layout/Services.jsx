    ...
    const services = [
        {
            ...
            secondary: 'Get 10% Flat Discount  Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus quaerat excepturi sit',
        ...
        },
        {
            ...
            ,
            iconbg: "rgb(255,0,0,0.10)",
            iconColor: 'rgb(255,0,0)'
        },

        {
            primary: 'Quality Images',
            secondary: 'Get 10% Flat Discount  Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus quaerat excepturi sit',
            icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
