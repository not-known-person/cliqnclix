...
const Testimonials = () => {
    ...
    return (
        <div className='flex flex-col items-center my-12 gap-36  py-4 m-5 rounded-lg' >
            ...
            <div className='flex gap-4 flex-wrap justify-center'>
                {testimonials.map((el) => {
                    return (
                        <div className=' shadow-md flex flex-col gap-2  m-10 relative text-white max-w-xs bg-clip-padding backdrop-filter backdrop-brightness-75 backdrop-blur-sm  bg-opacity-10 text-center rounded-xl'>
                            <div className='absolute top-[-106px] left-[70px]  rounded-full p-3'>
                                <img src={el.src} alt="" className=' m-auto rounded-full' />
                            </div>
                            <div className=' h-full p-4 pt-20 rounded-xl'>
