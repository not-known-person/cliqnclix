                ...
                component={
                    <div className='text-gray-200'>
                        <div className='backdrop-filter backdrop-brightness-75 backdrop-blur-sm  bg-opacity-10 lg:m-3 rounded-xl'>
                            <h1 className='font-black text-2xl p-3' >
                                    ...
                                    <div>
                                        {
                                            options.map(property => {
                                                return (
                                                    <div className='px-1 lg"px-3 py-2 flex flex-col gap-2' >
                                        ...
                                        <div className='px-3 py-2 flex flex-col gap-2'>
                                            ...
                                            <div className='flex gap-5' >
                                                <div className=' border border-gray-400/45 rounded-full flex' >
                                                    <div className='bg-gray-700 text-white rounded-md px-6 py-3 rounded-s-full p-3'>
                                                    ...
                                                    <div className='bg-gray-700 text-white rounded-md px-6 py-3 rounded-e-full p-3'>
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        ...
                                        <button className=' rounded-md my-3 flex gap-2 items-center text-white px-5 sm:px-6 sm:py-4 py-3   font-semibold bg-gray-700 shadow-md'  ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        ...
                                        if (property.prop == 'Rating') {
                                            return (
                                                <div className='lg:px-3 py-2 flex flex-col gap-2 items-center w-full justify-center' >
                                                    <div className='rounded-full w-min p-4 flex justify-center items-center bg-red-800/50 text-red-1000'    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                            ...
                                            return (
                                                <div className='lg:px-3 py-3 flex flex-col gap-4 justify-center items-center w-full' >
                                                    <div className='rounded-full w-min p-4 flex justify-center items-center bg-blue-800/50 text-red-1000'  >
                                                        {property.icon}
                                                    </div>
                                                    <h3 className='text-lg font-semibold '>
                                                        {property.prop}
